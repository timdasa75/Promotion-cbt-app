...
def restructure_json():
    ...
    # Check if the last subcategory is 'ca_general' and has questions
    if data['subcategories'] and data['subcategories'][-1]['id'] == 'ca_general' and data['subcategories'][-1]['questions']:
        questions_to_categorize = data['subcategories'][-1]['questions']
    else:
        # If not, maybe the questions are in the first subcategory
        questions_to_categorize = data['subcategories'][0]['questions']

    for question in questions_to_categorize:
        assigned = False
