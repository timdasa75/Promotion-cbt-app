#!/usr/bin/env python3
"""Apply curated question-quality move batch round 3."""
...
DEFAULT_LOG_JSON = ROOT / "docs" / "question_quality_batch1_applied_moves_round3.json"
DEFAULT_LOG_MD = ROOT / "docs" / "question_quality_batch1_applied_moves_round3.md"
...
MOVE_SPECS = [
    MoveSpec("ict_eg_092", "ict_management", "ict_e_governance", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("ict_eg_093", "ict_management", "ict_e_governance", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("ict_li_099", "ict_management", "ict_literacy_innovation", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
]
...
def write_markdown(path: Path, payload):
    ...
    lines = [
        "# Question Quality Batch 1 Applied Moves Round 3",
        "",
