#!/usr/bin/env python3
"""Apply curated question-quality move batch round 7."""
...
DEFAULT_LOG_JSON = ROOT / "docs" / "question_quality_batch1_applied_moves_round7.json"
DEFAULT_LOG_MD = ROOT / "docs" / "question_quality_batch1_applied_moves_round7.md"
...
MOVE_SPECS = [
    MoveSpec("clg_gc_070", "constitutional_law", "clg_general_competency", "civil_service_admin", "csh_principles_ethics", "csh_principle_", "Civil Service Principles & Ethics"),
]
...
def write_markdown(path: Path, payload):
    ...
    lines = [
        "# Question Quality Batch 1 Applied Moves Round 7",
        "",
