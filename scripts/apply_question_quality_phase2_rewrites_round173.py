...
REWRITES = {
    'csh_administrative_procedures_gen_029': 'Accountable implementation requires consistent use of approved procedures and a written record of each material step so decisions can be checked later.',
    'csh_it_054': 'Costing of projects and services is the correct answer because due procedure is meant to protect fiscal transparency and compliance in public spending.',
    ...
    'csh_principles_ethics_gen_028': 'Accountable implementation requires consistent use of approved procedures and a written record of each material step so decisions can be checked later.',
