#!/usr/bin/env python3
"""Apply curated question-quality move batch round 6."""
...
DEFAULT_LOG_JSON = ROOT / "docs" / "question_quality_batch1_applied_moves_round6.json"
DEFAULT_LOG_MD = ROOT / "docs" / "question_quality_batch1_applied_moves_round6.md"
...
MOVE_SPECS = [
    MoveSpec("PSIR_073", "general_current_affairs", "ca_public_service_reforms", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("policy_psr_031", "policy_analysis", "pol_implementation_evaluation", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
]
...
def write_markdown(path: Path, payload):
    ...
    lines = [
        "# Question Quality Batch 1 Applied Moves Round 6",
        "",
