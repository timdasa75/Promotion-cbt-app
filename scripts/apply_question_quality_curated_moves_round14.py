#!/usr/bin/env python3
"""Apply curated question-quality move batch round 14."""
...
DEFAULT_LOG_JSON = ROOT / "docs" / "question_quality_batch1_applied_moves_round14.json"
DEFAULT_LOG_MD = ROOT / "docs" / "question_quality_batch1_applied_moves_round14.md"
...
MOVE_SPECS = [
    MoveSpec("neg_dispute_law_gen_017", "leadership_management", "neg_dispute_law", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("neg_dispute_law_gen_035", "leadership_management", "neg_dispute_law", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
]
...
def write_markdown(path: Path, payload):
    ...
    lines = [
        "# Question Quality Batch 1 Applied Moves Round 14",
        "",
