#!/usr/bin/env python3
"""Apply curated question-quality move batch round 12."""
...
DEFAULT_LOG_JSON = ROOT / "docs" / "question_quality_batch1_applied_moves_round12.json"
DEFAULT_LOG_MD = ROOT / "docs" / "question_quality_batch1_applied_moves_round12.md"
...
MOVE_SPECS = [
    MoveSpec("leadership_lsm_054", "leadership_management", "lead_principles_styles", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("leadership_lsm_065", "leadership_management", "lead_principles_styles", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
]
...
def write_markdown(path: Path, payload):
    ...
    lines = [
        "# Question Quality Batch 1 Applied Moves Round 12",
        "",
