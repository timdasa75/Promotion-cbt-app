#!/usr/bin/env python3
"""Apply curated question-quality move batch round 4."""
...
DEFAULT_LOG_JSON = ROOT / "docs" / "question_quality_batch1_applied_moves_round4.json"
DEFAULT_LOG_MD = ROOT / "docs" / "question_quality_batch1_applied_moves_round4.md"
...
MOVE_SPECS = [
    MoveSpec("policy_constitution_039", "policy_analysis", "pol_formulation_cycle", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("policy_constitution_041", "policy_analysis", "pol_formulation_cycle", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("policy_constitution_044", "policy_analysis", "pol_formulation_cycle", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("policy_constitution_051", "policy_analysis", "pol_formulation_cycle", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("policy_constitution_052", "policy_analysis", "pol_formulation_cycle", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("policy_constitution_057", "policy_analysis", "pol_formulation_cycle", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("leadership_smp_052", "leadership_management", "lead_strategic_management", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("leadership_smp_053", "leadership_management", "lead_strategic_management", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("leadership_smp_054", "leadership_management", "lead_strategic_management", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("neg_structure_bodies_gen_064", "leadership_management", "neg_structure_bodies", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("neg_structure_bodies_gen_065", "leadership_management", "neg_structure_bodies", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
]
