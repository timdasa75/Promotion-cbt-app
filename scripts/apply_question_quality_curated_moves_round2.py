#!/usr/bin/env python3
"""Apply a second curated batch of high-confidence question moves with ID renaming."""
...
MOVE_SPECS = [
    MoveSpec("ppa_elb_026", "procurement_act", "proc_eligibility_consultants_budgeting", "financial_regulations", "fin_budgeting", "fin_bgt_"),
    MoveSpec("ppa_ims_027", "procurement_act", "proc_implementation_sanctions", "psr", "psr_discipline", "psr_disc_"),
    MoveSpec("ppa_ims_032", "procurement_act", "proc_implementation_sanctions", "civil_service_admin", "csh_discipline_conduct", "csh_disc_"),
    MoveSpec("leadership_lsm_014", "leadership_management", "lead_principles_styles", "civil_service_admin", "csh_principles_ethics", "csh_principle_"),
    MoveSpec("leadership_lsm_031", "leadership_management", "lead_principles_styles", "civil_service_admin", "eth_code_conduct", "eth_code_conduct_gen_"),
]
