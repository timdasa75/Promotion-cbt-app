#!/usr/bin/env python3
"""Apply curated question-quality move batch round 10."""
...
DEFAULT_LOG_JSON = ROOT / "docs" / "question_quality_batch1_applied_moves_round10.json"
DEFAULT_LOG_MD = ROOT / "docs" / "question_quality_batch1_applied_moves_round10.md"
...
MOVE_SPECS = [
    MoveSpec("leadership_lsm_063", "leadership_management", "lead_principles_styles", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("leadership_lsm_075", "leadership_management", "lead_principles_styles", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("leadership_smp_059", "leadership_management", "lead_strategic_management", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
]
...
def write_markdown(path: Path, payload):
    ...
    lines = [
        "# Question Quality Batch 1 Applied Moves Round 10",
        "",
...
def apply_moves(root: Path):
    ...
    for spec in MOVE_SPECS:
        ...
        updated["lastReviewed"] = "2026-04-03"
