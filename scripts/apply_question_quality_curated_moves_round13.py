#!/usr/bin/env python3
"""Apply curated question-quality move batch round 13."""
...
DEFAULT_LOG_JSON = ROOT / "docs" / "question_quality_batch1_applied_moves_round13.json"
DEFAULT_LOG_MD = ROOT / "docs" / "question_quality_batch1_applied_moves_round13.md"
...
MOVE_SPECS = [
    MoveSpec("neg_principles_outcomes_gen_035", "leadership_management", "neg_principles_outcomes", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
]
...
def write_markdown(path: Path, payload):
    ...
    lines = [
        "# Question Quality Batch 1 Applied Moves Round 13",
        "",
