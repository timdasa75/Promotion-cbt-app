#!/usr/bin/env python3
"""Apply curated question-quality move batch round 11."""
...
DEFAULT_LOG_JSON = ROOT / "docs" / "question_quality_batch1_applied_moves_round11.json"
DEFAULT_LOG_MD = ROOT / "docs" / "question_quality_batch1_applied_moves_round11.md"
...
MOVE_SPECS = [
    MoveSpec("ppa_ethic_060", "procurement_act", "proc_transparency_ethics", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
]
...
def write_markdown(path: Path, payload):
    ...
    lines = [
        "# Question Quality Batch 1 Applied Moves Round 11",
        "",
