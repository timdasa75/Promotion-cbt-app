#!/usr/bin/env python3
"""Apply curated question-quality move batch round 16."""
...
DEFAULT_LOG_JSON = ROOT / "docs" / "question_quality_batch1_applied_moves_round16.json"
DEFAULT_LOG_MD = ROOT / "docs" / "question_quality_batch1_applied_moves_round16.md"
...
MOVE_SPECS = [
    MoveSpec("lead_management_performance_gen_023", "leadership_management", "lead_management_performance", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
]
...
def write_markdown(path: Path, payload):
    ...
    lines = [
        "# Question Quality Batch 1 Applied Moves Round 16",
        "",
