#!/usr/bin/env python3
"""Apply curated question-quality move batch round 15."""
...
DEFAULT_LOG_JSON = ROOT / "docs" / "question_quality_batch1_applied_moves_round15.json"
DEFAULT_LOG_MD = ROOT / "docs" / "question_quality_batch1_applied_moves_round15.md"
...
MOVE_SPECS = [
    MoveSpec("FOI_AO_067", "constitutional_law", "foi_access_obligations", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("FOI_EX_066", "constitutional_law", "foi_exemptions_public_interest", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
    MoveSpec("FOI_EX_067", "constitutional_law", "foi_exemptions_public_interest", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
]
...
def write_markdown(path: Path, payload):
    ...
    lines = [
        "# Question Quality Batch 1 Applied Moves Round 15",
        "",
...
def apply_moves(root: Path):
    ...
    for spec in MOVE_SPECS:
        ...
        updated["chapter"] = CHAPTER_BY_SUBCATEGORY.get(spec.target_subcategory, str(updated.get("chapter") or "").strip())
        ...
        updated["lastReviewed"] = "2026-04-04"
