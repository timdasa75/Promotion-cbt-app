    ...
    (
        ROOT / 'data' / 'civil_service_ethics.json',
        {
            'csh_ap_140': {
                ...
                'options': [
                    'The meeting objectives are taken seriously.',
                    'The chair is more senior than the members.',
                    'The participants are rushed into decisions.',
                    'The meeting is reduced regardless of the agenda.',
                ],
                'correct': 0,
            ...
            'csh_ap_220': {
                ...
                'options': [
                    'The contents are checked monthly by the officer in charge of the keys.',
                    'The contents are checked only when a discrepancy is suspected.',
                    'The contents are checked once a year.',
                    'The contents are checked only at handover.',
                ],
                'correct': 0,
            ...
            'csh_ap_045': {
                ...
                'options': [
                    'The form is forwarded two weeks before the end date.',
                    'The form is forwarded three working days before duties cease.',
                    'The form is forwarded at the end of the quarter of cessation.',
                    'The form is forwarded only after handover is complete.',
                ],
                'correct': 0,
            ...
            'csh_ap_101': {
                ...
                'options': [
                    'The file is routed through restricted access and secure handling.',
                    'The file is routed through open-registry circulation under routine controls.',
                    'The file is routed through public circulation channels.',
                    'The file is routed through general e-mail distribution.',
                ],
                'correct': 0,
            ...
            'csh_ap_136': {
                ...
                'options': [
                    'The document is removed only to correct a grave error with approval.',
                    'The document is removed as soon as it is no longer needed.',
                    'The document is removed whenever an officer is in a hurry.',
                    'The document is removed whenever the document is personal.',
                ],
                'correct': 0,
            ...
            'csh_ap_137': {
                ...
                'options': [
                    'The file is updated at each control point and the status is kept traceable.',
                    'The file is held until the negotiation is concluded before updates are filed.',
                    'The file relies on memory instead of written records.',
                    'The file lets each side keep separate private notes.',
                ],
                'correct': 0,
            ...
            'csh_ap_139': {
                ...
                'options': [
                    ...
                    'The hearing record records only the final decision.',
                    'The hearing record lets each representative keep separate notes.',
                ],
                'correct': 0,
            ...
            'csh_ap_219': {
                ...
                'options': [
                    ...
                    'The payee\'s mark does not need to be recorded.',
                ],
                'correct': 0,
            ...
            'csh_ap_227': {
                ...
                'options': [
                    'The log keeps accurate files and updates status at each control point.',
                    'The log bypasses review controls.',
                    'The log prioritizes convenience over compliance.',
                    'The log applies rules inconsistently.',
                ],
                'correct': 0,
            ...
            'csh_disc_051': {
                ...
                'options': [
                    'The register draws a red line, and latecomers sign below it.',
                    'The register gets a note beside each late name.',
                    'The register lets everyone sign in exactly the same place without distinction.',
                    'The register sends latecomers to a separate attendance sheet.',
                ],
                'correct': 0,
            ...
            'csh_ap_205': {
                ...
                'options': [
                    'The circular is kept in the file with the related matter.',
                    'The circular is circulated to the public.',
                    'The circular is discarded after reading.',
                    'The circular is kept for personal use only.',
                ],
                'correct': 0,
    ...
    (
        ROOT / 'data' / 'psr_rules.json',
        {
            'psr_general_admin_gen_009': {
                ...
                'options': [
                    'The unit applies applicable PSR provisions consistently and keeps auditable records.',
                    'The unit bypasses review checkpoints where timelines are tight.',
                    'The unit applies discretionary shortcuts to accelerate closure regardless of controls.',
                    'The unit prioritizes convenience over approved process requirements.',
                ],
                'correct': 0,
            ...
            'psr_general_admin_gen_003': {
                ...
                'options': [
                    'The unit identifies control gaps early and escalates material exceptions promptly.',
                    'The unit bypasses review and approval controls to save time.',
                    'The unit prioritizes convenience over policy and legal requirements.',
                    'The unit ignores feedback and continues non-compliant procedures.',
                ],
                'correct': 0,
            ...
            'psr_general_admin_gen_007': {
                ...
                'options': [
                    'The unit confirms eligibility requirements before recommending advancement.',
                    'The unit ignores feedback and continues non-compliant procedures.',
                    'The unit applies rules inconsistently based on personal preference.',
                    'The unit bypasses review and approval controls to save time.',
                ],
                'correct': 0,
            ...
            'psr_admin_025': {
                ...
                'options': [
                    'The vehicles and equipment are used only for official purposes.',
                    'The vehicles and equipment are used for personal errands when official work is done.',
                    'The vehicles and equipment are used for emergencies at night.',
                    "The vehicles and equipment are used with supervisor's informal consent.",
                ],
                'correct': 0,
            ...
            'psr_admin_026': {
                ...
                'options': [
                    'The department head ensures that government property and records are properly maintained.',
                    'The department head ensures that staff arrive early to work.',
                    'The department head ensures that only senior officers sign correspondence.',
                    'The department head ensures that all staff attend weekly meetings.',
                ],
                'correct': 0,
            ...
            'psr_admin_068': {
                ...
                'options': [
                    'The unit makes available all necessary information on acts and procedures in its domain.',
                    'The unit makes available only information requested in person.',
                    'The unit makes available no information because it is all classified.',
                    'The unit makes available only information already published in a newspaper.',
                ],
                'correct': 0,
...
def main() -> None:
    ...
    for target, updates in TARGETS:
        ...
        print(f'Applied round 142 updates to {changed} questions in {target}')
    print(f'Applied round 142 updates to {total_changed} questions across {len(TARGETS)} files')
