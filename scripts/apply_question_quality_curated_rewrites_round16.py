#!/usr/bin/env python3
"""Apply curated question quality rewrites for round 16."""
...
DEFAULT_LOG_JSON = ROOT / "docs" / "question_quality_batch1_applied_rewrites_round16.json"
DEFAULT_LOG_MD = ROOT / "docs" / "question_quality_batch1_applied_rewrites_round16.md"

REWRITES = {
    "psr_admin_060": {
        "question": "Which description best matches a subject file in office records management?",
        "explanation": "In office records management, a subject file is a file containing official correspondence and related documents on a particular subject matter.",
        "keywords": ["subject_file", "records_management", "official_correspondence", "office_records"],
        "tags": ["psr", "psr_general_admin", "subject_file", "records_management", "office_records"],
    },
    "psr_eth_060": {
        "question": "To which body should allegations that a public officer has breached the Code of Conduct be reported?",
        "explanation": "Allegations that a public officer has breached the Code of Conduct should be reported to the Code of Conduct Bureau, which receives and processes such complaints.",
        "keywords": ["code_of_conduct_bureau", "breach_reporting", "public_officers", "complaints"],
        "tags": ["psr", "psr_ethics", "code_of_conduct_bureau", "breach_reporting", "public_service_ethics"],
    },
}
...
def write_markdown(path: Path, payload):
    ...
    lines = [
        "# Question Quality Batch 1 Applied Rewrites Round 16",
        "",
...
def main():
    ...
    payload = {"round": 16, "applied": applied}
