...
REWRITES = {
    'csh_ap_155': {
        ...
        'options': [
            'Current, traceable movement entries at each control point.',
            'Inconsistent rule application.',
            'Bypassing required review steps.',
            'Late updates after the case is closed.',
        ],
        'correct': 0,
    ...
    'csh_ap_217': {
        ...
        'options': [
            'An indexed file that stays current at each control point.',
            'Inconsistent rule application.',
            'Bypassing required review steps.',
    ...
    'csh_ap_228': {
        ...
        'options': [
            ...
            'Budget expansion without oversight.',
    ...
    'csh_disc_062': {
        ...
        'options': [
            'Bring-up pad and registry return.',
            'Discarding the file immediately.',
            'Permanent desk-drawer storage.',
            'Passing the file without recording the transfer.',
        ],
        'correct': 0,
    ...
    'csh_duty_064': {
        ...
        'options': [
            'Continuing accountability until discrepancies are resolved.',
    ...
    'csh_duty_068': {
        ...
        'options': [
            'Total expenditure staying within total revenue.',
            'Total revenue always exceeding expenditure by a fixed margin.',
            'Revenue being irrelevant to expenditure decisions.',
            'Expenditure exceeding revenue whenever grants are expected.',
        ],
        'correct': 0,
    ...
    'csh_innovation_technology_gen_007': {
        ...
        'options': [
            'Consistent compliance with approved technology-use standards.',
            'Selective rule application for convenience.',
            'Bypassing required review steps.',
            'Informal practice instead of approved process.',
        ],
        'correct': 0,
        'explanation': 'Discipline in technology use depends on consistent compliance with approved standards instead of shortcuts or informal practice.',
    },
    'csh_innovation_technology_gen_025': {
        ...
        'options': [
            'Consistent compliance with approved technology-use conduct standards.',
            'Selective rule application for convenience.',
            'Bypassing required review steps.',
            'Informal practice instead of approved process.',
        ],
    ...
    'csh_it_068': {
        ...
        'options': [
            'Timely and efficient discharge of assigned public duties.',
    ...
    'csh_it_073': {
        ...
        'options': [
            'Compromise of official integrity and conflict of interest.',
            'An act of kindness in official business.',
            'A normal feature of contractor relations.',
            'A reliable way to build workplace relationships.',
        ],
        'correct': 0,
    ...
    'csh_principle_024': {
        ...
        'options': [
            'Responsible use strictly for official purposes.',
            'Personal benefit where rank permits.',
            'Family and private development projects.',
            'Informal sharing once duties are complete.',
        ],
        'correct': 0,
    ...
    'csh_principle_064': {
        ...
        'options': [
            'Reporting through the proper official channel.',
            'Ignoring it because it is not a personal duty.',
            'Waiting for a superior to discover it first.',
            'Reporting informally to a friend or colleague.',
        ],
        'correct': 0,
    ...
    'csh_principle_069': {
        ...
        'options': [
            'Minutes circulation and agreed follow-up actions.',
    ...
    'csh_principle_071': {
        ...
        'options': [
            'Adequate accounting systems across government.',
    ...
    'csh_principle_072': {
        ...
        'options': [
            'Accountability remains with the delegating officer.',
            'Delegation removes accountability once it is in writing.',
            'Delegation removes accountability when the subordinate accepts the task.',
            'Delegation removes accountability only for revenue duties.',
        ],
        'correct': 0,
    ...
    'csh_principles_ethics_gen_014': {
        ...
        'options': [
            ...
            'Convenience over control requirements.',
    ...
    'csh_pt_051': {
        ...
        'options': [
            ...
            'Why an officer is leaving the Service.',
    ...
    'csh_pt_070': {
        ...
        'options': [
            'Reporting through the proper official channel.',
            'Reporting to a friend or colleague.',
            'Waiting for a superior to discover it first.',
            'Ignoring it because it is not a personal duty.',
        ],
        'correct': 0,
