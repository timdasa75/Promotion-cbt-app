#!/usr/bin/env python3
"""Apply curated question-quality move batch round 9."""
...
DEFAULT_LOG_JSON = ROOT / "docs" / "question_quality_batch1_applied_moves_round9.json"
DEFAULT_LOG_MD = ROOT / "docs" / "question_quality_batch1_applied_moves_round9.md"
...
MOVE_SPECS = [
    MoveSpec("FOI_AO_074", "constitutional_law", "foi_access_obligations", "civil_service_admin", "csh_administrative_procedures", "csh_ap_"),
]
...
def write_markdown(path: Path, payload):
    ...
    lines = [
        "# Question Quality Batch 1 Applied Moves Round 9",
        "",
